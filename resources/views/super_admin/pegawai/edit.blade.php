                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="agama"
                                                    ...
                                                    @foreach ($agama as $ag)
                                                        <option
                                                            value="{{ $ag->id }}"{{ old('agama', $data->agama) == $ag->id ? 'selected' : null }}>
                                                            {{ $ag->nama }}</option>
                                                    @endforeach
                                                </select>
                                                @error('agama')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input name="gelar" value="{{ old('gelar', $data->gelar) }}"
                                                    type="text"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <img class="img img-fluid " src="/image/images/{{ $data->foto_npwp }}"
                                                    width="100px" height="100px" alt="User profile picture">
                                            </div>
                                        </div>
                                    </div>
