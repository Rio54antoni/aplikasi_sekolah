            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Mata Pelajaran / Edit</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <form action="{{ route('mata_pelajarans.update', $data->id) }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_guru" class="form-control @error('id_guru') is-invalid @enderror">
                                    ...
                                    @foreach ($mata as $ag)
                                        <option
                                            value="{{ $ag->id }}"{{ old('id_guru', $data->id_guru) == $ag->id ? 'selected' : null }}>
                                            {{ $ag->nama }}</option>
                                    @endforeach
                                </select>
                                @error('id_guru')
